...
/Users/lray/Sites/babygirlatl/wp-content/themes/blueprint/partials//components/card/title-text-links.php
-->";
};

# src: webpack/src/blueprint/partials/components/card/title-text-links.ejs